...
@section('content')
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor">Profile Create</h3>
            <ol class="breadcrumb">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('profile.store') }}"
                        ...
                        <div class="form-group">
                            <label class="col-md-12" for="img">Select Favicon:</label>
                            <div class="col-md-12">
                                <input type="file" class="btn btn-primary" id="image" name="favicon" accept="image/*" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-12">
