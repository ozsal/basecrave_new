...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-8 col-xlg-9 col-md-7">
            <div class="card">
                <div class="card-body">
                    <form method="post" action="{{ route('openinghour.update', $openinghour->id) }}"
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="day" class="form-control" value="{{ $openinghour->day}}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-12">
                                <label class="col-md-12">From Time</label>
                                <input type="time" name="fromtime" class="form-control" value="{{ $openinghour->fromtime}}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-12">
                                <label class="col-md-12">Till Time</label>
                                <input type="time" name="totime" class="form-control" value="{{ $openinghour->totime}}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-12">
