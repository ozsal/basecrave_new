...
@section('content')
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor">More Information</h3>
            <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Menu Categories Table</h4>
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                    ...
                                    <td class="text-center">{{$row->categories_name}}</td>
                                    <td  width="15%">
                                        <a type="button" href="{{ route('categories.edit', $row->id) }}"
    ...
    <script>
        $(document).ready(function () {
            $(document).on('click', '#deleteButton', function () {
                ...
                let $categoriesid = $(this).attr('data-id');

                let url = '{{route('categories.destroy',123)}}';
                url = url.replace(123, $categoriesid);
                swal({
                    title: "Are you sure?",
                    ...
                    if (willDelete) {
                        $.ajax({
                            ...
                            success: function (res) {
                                if (res == "true") {
                                    swal("Categories successfully deleted!", {
                                        icon: "success",
                                    });
                                    $deleteRow.remove();
                                } else {
                                    swal("Categories did not delete !", {
                                        icon: "warning",
                                    });
                                }
                            }
